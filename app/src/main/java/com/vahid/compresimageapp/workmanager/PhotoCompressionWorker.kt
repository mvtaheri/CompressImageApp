package com.vahid.compresimageapp.workmanager
...
class PhotoCompressionWorker(
    ...
    override suspend fun doWork(): Result {
        return withContext(Dispatchers.IO) {
            ...
            val compressionThresholdInByt = params.inputData.getLong(
            ...
            } while (outputBytes.size > compressionThresholdInByt && quality > 5)
